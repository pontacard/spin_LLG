...
class FMR_spin(A_spin):
    ...
    def func_S(self,t,S):  # 関数を設定
        B = np.array(self.B) + np.array([self.Amp[0] * np.cos(self.omega[0] * t) , self.Amp[1] * np.sin(self.omega[1] * t),self.Amp[2] * np.sin(self.omega[2] * t)])
        #print(B)
...
if __name__ == '__main__':
    ...
    spin = FMR_spin(0.01,-0.17,[0,0,-5],S0,t,t_eval,[10,10,0],[0.8,0.8,0])
    spin.doit()
